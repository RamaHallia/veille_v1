-- ========================================
-- SCRIPT DE CORRECTION COMPLET RAG
-- ========================================
-- Ce script corrige TOUS les problèmes identifiés
-- Exécutez-le en UNE SEULE FOIS dans Supabase SQL Editor
-- ========================================
...
CREATE OR REPLACE FUNCTION search_rapport_chunks(
  query_embedding VECTOR(3072),  -- ⚠️ 3072 dimensions pour text-embedding-3-large
  user_client_id UUID,
...
-- Supprimer tous les anciens chunks (ils seront réindexés)
...
BEGIN
  ...
  RAISE NOTICE '  1. Déployez les Edge Functions (voir FIX_COMPLET_RAG.md)';
